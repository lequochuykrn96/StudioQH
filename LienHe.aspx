...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:TextBox ID="LoiNhan" runat="server" CssClass="Textloinhan" placeholder="Nội dung mà bạn muốn được tư vấn..." TextMode="MultiLine"></asp:TextBox> </br>
    <asp:Button ID="gui" runat="server" Text="Gửi" OnClick="gui_Click" />  
            <div id="Hloinhan" runat="server" Visible ="false"><asp:Label ID="Hienthiloinhan" runat="server" Text="Label"></asp:Label><a>: </a><asp:Label ID="Hienloinhan" runat="server" Text="Label"></asp:Label> </br> Admin: Chúng tôi sẽ liên hệ trực tiếp cho bạn trong thời gian sớm nhất</div>      
            </div>       
    </div>
    <div id="Pglienhe3">
